@php
    ...
    $icons = [
        ...
        'eye'          => '<path d="M2.5 12C4.5 7 8 4.5 12 4.5S19.5 7 21.5 12c-2 5-5.5 7.5-9.5 7.5S4.5 17 2.5 12Z"/><circle cx="12" cy="12" r="3"/>',
        'eye-off'      => '<path d="M17.9 17.9A10.1 10.1 0 0 1 12 19.5C8 19.5 4.5 17 2.5 12a10.2 10.2 0 0 1 4.6-5.3M9.9 4.7A9.5 9.5 0 0 1 12 4.5c4 0 7.5 2.5 9.5 7.5a10.2 10.2 0 0 1-1.5 2.7"/><path d="M9.9 9.9a3 3 0 0 0 4.2 4.2"/><path d="m3 3 18 18"/>',
        'download'     => '<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/>',
        'info'         => '<circle cx="12" cy="12" r="8.2"/><path d="M12 8v4M12 16h.01"/>',
