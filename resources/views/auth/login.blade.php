...
<title>Login — Bank Sulteng</title>
<style>
...
.brand-copy{max-width:510px;margin-top:auto;padding-bottom:24px}.brand-copy h1{margin:0 0 8px;font-size:clamp(36px,3.5vw,50px);line-height:1.1;font-weight:800;letter-spacing:.01em}.subtitle{margin:0 0 22px;color:#f2b92c;font-size:clamp(18px,1.8vw,24px);font-weight:650}.description{margin:0;max-width:500px;font-size:16px;line-height:1.65;color:rgba(255,255,255,.94)}
...
@media(max-width:600px){.login-page{padding:0}.login-shell{min-height:100vh;border-radius:0}.brand-panel{min-height:365px;padding:28px 25px}.brand-logo{width:190px}.brand-copy{margin-top:52px}.brand-copy h1{font-size:34px}.subtitle{font-size:18px}.description,.security-note,.brand-footer{display:none}.form-panel{padding:42px 25px 50px;align-items:flex-start}.login-card h2{font-size:31px}}
</style>
</head>
<body>
...
<h1>Portal Operasional</h1>
<p class="subtitle">Divisi Umum &amp; Logistik Aset</p>
<p class="description">Sistem terintegrasi untuk pengelolaan data operasional, aset, dan pengadaan PT Bank Sulteng.</p>
